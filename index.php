  ...
  <form action="" method="post" novalidate>
    <div class="divForm">
      ...
      <div class="formDegree divFormElt">
        ...
        <?php } ?>
        <!-- <input type="radio" id="degreeWithout" name="degree" value="sans"><label for="degreeWithout" required>Sans</label><br>
          <input type="radio" id="degreeBac" name="degree" value="bac"><label for="degreeBac" required>Bac</label><br>
          <input type="radio" id="degreeBacPlusTwo" name="degree" value="bac+2" checked><label for="degreeBacPlusTwo" required>Bac+2</label><br>
          <input type="radio" id="degreeBacPlusThree" name="degree" value="bac+3"><label for="degreeBacPlusThree" required>Bac+3 ou supérieur</label><br> -->
